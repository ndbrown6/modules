...
ascat/log2/$1_$2.pdf : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 12G -m 24G,"$(RSCRIPT) modules/copy_number/ascat.R --type log2 --file_in $$< --file_out ascat/log2/$1_$2.pdf")
...
ascat/bafall/$1_$2.pdf : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 12G -m 24G,"$(RSCRIPT) modules/copy_number/ascat.R --type bafall --file_in $$< --file_out ascat/bafall/$1_$2.pdf")
...
ascat/bafhet/$1_$2.pdf : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 12G -m 24G,"$(RSCRIPT) modules/copy_number/ascat.R --type bafhet --file_in $$< --file_out ascat/bafhet/$1_$2.pdf")
...
ascat/mad/$1_$2.RData : facets/cncf/$1_$2.Rdata
	$$(call RUN,-c -v $(ASCAT_ENV) -s 12G -m 24G,"$(RSCRIPT) modules/copy_number/ascat.R --type aspcf --file_in $$< --file_out ascat/mad/$1_$2.RData --gamma '$${aspcf_gamma.$1}'")
...
ascat/log2nbaf/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v $(ASCAT_ENV) -s 12G -m 24G,"$(RSCRIPT) modules/copy_number/ascat.R --type plot-aspcf --file_in $$< --file_out ascat/log2nbaf/$1_$2.pdf --nlog2 '$${aspcf_nlog2.$1}' --nbaf '$${aspcf_nbaf.$1}'")
...
ascat/ascat/$1_$2.pdf : ascat/mad/$1_$2.RData
	$$(call RUN,-c -v $(ASCAT_ENV) -s 12G -m 24G,"$(RSCRIPT) modules/copy_number/ascat.R --type run-ascat --file_in $$< --file_out ascat/ascat/$1_$2.pdf --rho '$${ascat_rho.$1}' --psi '$${ascat_psi.$1}' --nlog2 '$${aspcf_nlog2.$1}' --nbaf '$${aspcf_nbaf.$1}'")
	
ascat/total/$1_$2.pdf : facets/cncf/$1_$2.Rdata ascat/ascat/$1_$2.pdf
	$$(call RUN,-c -v $(ASCAT_ENV) -s 12G -m 24G,"$(RSCRIPT) modules/copy_number/ascat.R --type total-copy --file_in $$< --file_out ascat/total/$1_$2.pdf")	
