...
.DELETE_ON_ERROR:
.SECONDARY:
.PHONY: extract_any_unmapped_pairs

VPATH = bam
JAVA = $(HOME)/share/usr/jdk1.8.0_121/bin/java
PICARD = /lila/data/riazlab/lib/src/picard.jar

extract_any_unmapped_pairs : $(foreach sample,$(SAMPLES),extracted_reads/any_unmapped_pairs/fastq/$(sample)_1.fastq.gz)

define extract-any-unmapped-pairs
...
extracted_reads/any_unmapped_pairs/fastq/%_1.fastq.gz extracted_reads/any_unmapped_pairs/fastq/%_2.fastq.gz : extracted_reads/any_unmapped_pairs/%.bam
...
$(foreach pair,$(SAMPLES),\
		$(eval $(call extract-any-unmapped-pairs,$sample)))
