...
## 2. Extract all the paired reads based on the unique ID from step 1
extracted_reads/any_unmapped_pairs/%.bam : extracted_reads/unmapped_pairs/%.txt
	$$(call RUN,-c -n 4 -s 4G -m 9G,"$(JAVA) -jar $(PICARD) FilterSamReads I=bam/$$*.bam O=extracted_reads/unmapped_pairs/$$*.bam \
