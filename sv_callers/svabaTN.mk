...
svaba/$1_$2.svaba.somatic.indel.vcf : bam/$1.bam bam/$2.bam
	$$(call RUN,-c -n 16 -s 12G -m 14G -w 7200,"svaba run -t bam/$1.bam -n bam/$2.bam -p $$(CORES) -D $$(DBSNP) -L 100000 -x 25000 -k /data/riazlab/lib/reference/wgs_blacklist_meres.bed -a $1_$2 -G $$(SVABAREF) && mkdir -p svaba && mv *svaba*.vcf svaba/")
endef
